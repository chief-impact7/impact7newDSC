    ...
    return (
        <div className="daily-log-metric">
            <div className="daily-log-metric-label">
                <Icon svg={ICON_SVG[icon]} size={19} className="i7-icon" aria-hidden="true" />
                {label}
            </div>
...
function ClassGroup({ groupKey, classCode, rows, open = false }) {
    ...
    return (
        <details className="daily-log-class-details" open={open}>
            <summary>
                <Icon svg={ICON_SVG.chevron_right} size={20} className="daily-log-class-chev" aria-hidden="true" />
...
function AccordionGroup({ groupKey, rows, children, open = false }) {
    ...
    return (
        <details className="daily-log-details" open={open}>
            <summary>
                <Icon svg={ICON_SVG.chevron_right} size={24} className="daily-log-chev" aria-hidden="true" />
    ...
    return (
        <div className={`daily-log-side-card ${type}`}>
            <div className={`daily-log-side-head ${type}`}>
                <div>
                    <Icon svg={ICON_SVG[icon]} size={24} aria-hidden="true" />
                    {title}
                </div>
...
const ABSENCE_STATUS_META = {
    ...
    failed_permanent: { label: '발송 최종 실패', cls: 'failed', icon: 'error' },
};
                        ...
                        <div className="daily-log-side-note">
                            ...
                            {phone && onSend && (meta
                                ? <span className={`absence-sent-badge ${meta.cls}`}>
                                    {meta.icon && <Icon svg={ICON_SVG[meta.icon]} size={14} aria-hidden="true" />}
                                    {meta.label}
                                </span>
                                : <button
                                    type="button"
                ...
                <div className="daily-log-work-area">
                    <div className="daily-log-main-card">
                        <div className="daily-log-main-head">
                            <div>
                                <Icon svg={ICON_SVG.view_list} size={24} aria-hidden="true" />
                                학생별 일일 로그
                            </div>
