...
export const ICON_NAME = {
  ...
  send: 'paperAirplane',
  bulk_message: 'magnifyingGlassCircle',
  direct_message: 'devicePhoneMobile',
  notification_missing: 'bellAlert',
  message_history: 'chatBubbleLeftRight',
  phone_opt_out: 'phoneXMark',
  upload: 'upload',
  refresh: 'arrowPath',
  payments: 'banknotes',
