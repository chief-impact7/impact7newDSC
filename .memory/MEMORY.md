...
- [project_app_check_rollout.md](project_app_check_rollout.md) — App Check **도입 보류**(사용자 결정 2026-07-05, DSC init 제거 3d9dbb2·5앱 전부 없음). 재제안 금지 — 사용자 요청 시만. 재개 로드맵 SSoT는 impact7DB/.memory/project_appcheck_rollout.md
...
- [feedback_formal_review_over_equivalent.md](feedback_formal_review_over_equivalent.md) — 소스 변경 커밋은 정식 /simplify→/code-review 필수. "equivalent" 직접 점검으로 대체하면 Critical 버그를 놓친다
