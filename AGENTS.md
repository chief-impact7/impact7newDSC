...
impact7 에코시스템 공통 로직의 SSoT는 `/Users/jongsooyi/IMPACT7/impact7-shared` (`@impact7/shared`)다.
...
- 로컬 git hook은 staged source/security diff가 품질 확인 마커 없이 커밋되는 것을 차단한다. simplify/review/fix 후 해당 repo 루트에서 `node /Users/jongsooyi/IMPACT7/impact7DB/.agents/hooks/impact7-precommit-quality-guard.mjs --mark`로 현재 staged diff를 표시한다.
